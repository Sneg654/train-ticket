 ...
 * 
 */
@WebService(name = "TicketServer", targetNamespace = "http://servise.soap.epam.com/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface TicketServer {
     ...
     * @param numberTicket
     * @return
     *     returns com.epam.entity.FindTicketResponse.Return
     */
    @WebMethod
    ...
    public Integer bookedTicket(
        ...
        @WebParam(name = "human", targetNamespace = "http://servise.soap.epam.com/")
        Human human);
